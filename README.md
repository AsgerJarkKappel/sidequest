...
```
cd existing_repo
git remote add origin https://gitlab.au.dk/au606583/sidequest.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.au.dk/au606583/sidequest/-/settings/integrations)
